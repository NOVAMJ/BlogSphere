...
urlpatterns = [
    ...
    # Password reset flow — custom view so the link uses the real request domain
    path('password-reset/', views.PasswordResetView.as_view(html_email_template_name='registration/password_reset_email.html'), name='password_reset'),
